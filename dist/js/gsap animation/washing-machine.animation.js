...
gsap.to(".washing-machine__container .washing-machine",{width:322,height:350,})
...
gsap.fromTo(".washing-machine__container .washing-machine",{width:322,height:350,},{width:()=>mapSvg.getBoundingClientRect().width,height:()=>mapSvg.getBoundingClientRect().height,scrollTrigger:{trigger:".header",start:"40% top",end:"bottom top",scrub:true,}})
